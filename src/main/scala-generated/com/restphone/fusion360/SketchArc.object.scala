...
class SketchArc extends SketchCurve {
...
*/
def intersectionsWithResults(activeObject: SketchArc, sketchCurves: ObjectCollection): (Boolean, ObjectCollection, ObjectCollection) = {
