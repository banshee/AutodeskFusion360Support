...
trait SketchEllipseMinorRadiusDimension extends SketchDimension {
  ...
  */
  def createForAssemblyContext(occurrence: Occurrence): SketchEllipseMinorRadiusDimension = js.native
  /**
 ...
 */
@JSName("adsk.fusion.SketchEllipseMinorRadiusDimension")
object SketchEllipseMinorRadiusDimension extends js.Object {
  /**
  * Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
  */
  def createForAssemblyContext(occurrence: Occurrence): SketchEllipseMinorRadiusDimension = js.native
