...
class SketchFixedSpline extends SketchCurve {
...
object SketchFixedSpline extends js.Object {
  ...
  */
  ...
  object SketchFixedSplineUtilities {
    // no toSeq
/**
* Get the curves that intersect this curve along with the intersection points (Point2D)
*
...
*/
def intersectionsWithResults(activeObject: SketchFixedSpline, sketchCurves: ObjectCollection): (Boolean, ObjectCollection, ObjectCollection) = {
