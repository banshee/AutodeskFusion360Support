...
trait SymmetryConstraint extends GeometricConstraint {
  ...
  */
  def createForAssemblyContext(occurrence: Occurrence): SymmetryConstraint = js.native
  /**
  ...
  */
  val nativeObject: SymmetryConstraint = js.native
 ...
 */
@JSName("adsk.fusion.SymmetryConstraint")
object SymmetryConstraint extends js.Object {
  /**
  * Creates or returns a proxy for the native object - i.e. a new object that represents this object but adds the assembly context defined by the input occurrence.
  */
  def createForAssemblyContext(occurrence: Occurrence): SymmetryConstraint = js.native
